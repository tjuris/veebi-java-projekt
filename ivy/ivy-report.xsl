...
Size
    ...
    <xsl:template name="called" >
        ...
        <xsl:param
            name="resolver"
            select="$revision/@resolver" />

        <xsl:param
            name="isdefault"
            select="$revision/@default" />
...
,
 ...
 errors 
                                ...
                                <img
                                    alt="error"
                                    src="http://ant.apache.org/ivy/images/error.gif"
...
Artifacts size
 ...
 kB
            (
                                        ...
                                        <xsl:value-of select="round(sum(artifacts/artifact[@status=&apos;successful&apos;]/@size) div 1024)" />
 kB downloaded,

                                        <xsl:value-of select="round(sum(artifacts/artifact[@status=&apos;no&apos;]/@size) div 1024)" />
 kB in cache)
                                    </td>
                                </tr>
